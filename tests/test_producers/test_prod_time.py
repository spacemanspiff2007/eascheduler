...
def test_simple():
    ...
    for _ in range(10):
        ...
        assert producer.get_next(get_local_as_utc(1, 1, 8)) == get_local_as_utc(1, 2, 8)
        assert producer.get_next(get_local_as_utc(1, 2, 8)) == get_local_as_utc(1, 3, 8)
...
def test_filter():
    ...
    for _ in range(10):
        ...
        assert producer.get_next(get_local_as_utc(1, 6, 8)) == get_local_as_utc(1, 13, 8)
