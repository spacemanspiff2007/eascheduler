...
def get_params() -> Generator[ParameterSet, None, None]:
    ...
    yield pytest.param(
        SunriseProducer(), get_local_as_utc(3, 29, 12, year=2024), '2024-03-30T05:44:58+01:00',
        id='Sunrise-30'
    )
    # DST change is on 2024-03-31 02:00
    yield pytest.param(
        SunriseProducer(), get_local_as_utc(3, 30, 12, year=2024), '2024-03-31T06:42:37+02:00',
        id='Sunrise-31'
    )

    yield pytest.param(
        SunsetProducer(), get_local_as_utc(3, 30, 12, year=2024), '2024-03-30T18:37:42+01:00',
        id='Sunset-30'
    )
    yield pytest.param(
        SunsetProducer(), get_local_as_utc(3, 31, 12, year=2024), '2024-03-31T19:39:27+02:00',
        id='Sunset-31'
    )
